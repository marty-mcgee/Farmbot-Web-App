...
Rails.application.configure do
  ...
  config.eager_load                  = false # [MM] default: false
  ...
  config.assets.debug                = true # [MM] default: false
  config.assets.raise_runtime_errors = true # [MM] default: false
  config.serve_static_assets         = true # [MM] custom (for Render)
  config.assets.digest               = true # [MM] custom (for Render)
  # [MM] from development environment
